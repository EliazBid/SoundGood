...
COPY public.person (id, person_number, first_name, last_name, sibling_discount, zip, street, city) FROM stdin;
1	123456789012	John	Doe	t	12345	Main St	New York
2	987654321098	Jane	Smith	f	54321	Elm St	Los Angeles
3	567890123456	Alice	Johnson	t	67890	Oak St	Chicago
\.
...
COPY public.group_lesson (lesson_id, skilllevel) FROM stdin;
1	Intermediate
2	Beginner
3	Advanced
\.
...
COPY public.individual_lesson (lesson_id, instrument, skill_level) FROM stdin;
1	Violin	Advanced
2	Piano	Beginner
3	Trumpet	Intermediate
\.
...
COPY public.sibling (id, person_id) FROM stdin;
1	1
2	3
\.
...
--
-- Name: sibling_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.sibling_id_seq', 2, true);
