...
ALTER TABLE sibling ADD CONSTRAINT PK_sibling PRIMARY KEY (person_id,sibling);
...
ALTER TABLE person_lesson ADD CONSTRAINT PK_person_lesson PRIMARY KEY (person_id,lesson_id);
...
ALTER TABLE rental ADD CONSTRAINT FK_rental_0 FOREIGN KEY (person_id) REFERENCES person (id);
...
ALTER TABLE sibling ADD CONSTRAINT FK_sibling_1 FOREIGN KEY (sibling) REFERENCES person (id);
...
ALTER TABLE person_lesson ADD CONSTRAINT FK_person_lesson_0 FOREIGN KEY (person_id) REFERENCES person (id);
ALTER TABLE person_lesson ADD CONSTRAINT FK_person_lesson_1 FOREIGN KEY (lesson_id) REFERENCES lesson (id);
